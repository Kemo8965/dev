...
export const actions = {
   ...
   async activateUser({ state, commit }) {
    ...
    const newUser = state.user
       ...
       const {data: putResponse} = await api.put(`/auth/activateUser/${newUser._id}`, {newUser, paymentStatus: "Paid", startDate:firstDay.toLocaleDateString('en-GB'), endDate: lastDay.toLocaleDateString('en-GB') } )
