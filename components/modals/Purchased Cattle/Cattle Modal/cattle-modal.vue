       ...
       <b-form v-model="cattleForm" class="form">
         ...
         <h4> <span class="is-blue"> Cattle Production Stage </span></h4>
          ...
          <div class="columns">
            ...
            <b-select :disabled="!datePurchased" v-model="cattleProductionStage" placeholder="eg. Heifer, Cow">
              <option value="-- Select an Option --">--Select an option --</option>
              <option  v-if="cattleSex !== 'Male'" value="Heifer">Heifer</option>
              <option  v-if="cattleSex !== 'Male'" value="Pregnant">Pregnant</option>
              <option  v-if="cattleSex !== 'Male'" value="Cow">Cow</option>
              <option v-if="cattleSex === 'Male'" value="Bull">Bull</option>
         ...
         <h4> <span class="is-blue"> Price</span></h4>

         <div class="columns">
            
           <div  class="column is-three-quarters">
          
           <b-input :disabled="!cattleSex" type="number" v-model="cattlePrice" placeholder="ZMW"></b-input>
           </div>
         </div>
         ...
         <div class="columns">
           ...
           <div  class="column is-three-quarters">  
           <b-input :disabled="!cattlePrice" type="text" v-model="supplierName" placeholder="Supplier"></b-input>
           </div>
        ...
        <div class="columns">
           ...
           <div  class="column is-three-quarters">
            ...
            <b-input :disabled="!supplierName" type="text" v-model="purchasedEarTagID" placeholder="Ear Tag ID"></b-input>
           </div>
         </div>
        ...
        <div class="columns">
           ...
           <div  class="column is-three-quarters">
            ...
            <b-input :disabled="!purchasedEarTagID" type="text" v-model="earTagColor" placeholder="Ear Tag Color"></b-input>
           </div>
         </div>
        ...
        <div class="columns">
         ...
         <div class=" card my-4">
          ...
          <p>Dam:  {{cattleDam}}</p>
           <p>Sex:  {{cattleSex}}</p>
           <p>Production Stage: {{ cattleProductionStage }}</p>
           <p>Price: ZMW {{cattlePrice}}</p>
...
export default {
  name: 'CattleModal',
   ...
   computed: {
      ...
      'cattleForm.cattleProductionStage',
      'cattleForm.cattlePrice',
