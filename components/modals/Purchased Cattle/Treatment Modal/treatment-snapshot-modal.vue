       ...
       <b-form class="form">
         <div class="columns">
           <div  class="column is-half">
            ...
            <p >
              <span class="tag  is-light"> {{treatment.purchasedEarTagID}} </span>
...
export default {
  ...
  computed: {
     ...mapGetters('treatmentData', {
      treatment:'selectedPurchasedCattleTreatment',
  ...
  methods: {
    ...mapActions('treatmentData', ['load', 'selectPurchasedCattleTreatment']),
