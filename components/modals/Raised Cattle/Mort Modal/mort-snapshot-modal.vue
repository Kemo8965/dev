       ...
       <b-form class="form">
         ...
         <div class="columns">
           <div  class="column is-half">
            ...
            <p  placeholder="Supplier Name">
              <span class="tag is-danger is-light">  {{mortality.causeOfDeath}} </span>
            </p>
           </div>
         </div>
        ...
        <div class="columns">
           <div  class="column is-half">
            ...
            <p  placeholder="Supplier Name">
              <span class="tag is-primary is-light">  {{mortality.dateOfDeath}} </span>
            </p>
           </div>
         </div>
         ...
         <div class="columns">
           <div  class="column is-half">
              <h4> <span class="is-blue"> Date Recorded</span></h4>
            <p  placeholder="Supplier Name">
              <span class="tag is-primary is-light">  {{mortality.date}} </span>
            </p>
           </div>
         </div>
...
export default {
  ...
  methods: {
    ...mapActions('mortalitiesData', ['load','selectRaisedcattleMortality']),
