      ...
      <div>
       <b-form v-model="mortalitiesForm" class="form">
         ...
         <div class="columns">
              ...
              <b-tooltip label="Shows a list of cattle raised on the farm" position="is-right" type="is-dark"><h5 class="my-2">Raised Cattle List</h5></b-tooltip>
             <b-autocomplete
...
export default {
  name: 'MortModal',
   ...
   computed: {
    filteredDataArray() {
      ...
      'raisedCattleMortalitiesForm',
      'raisedCattleMortalitiesForm.raisedEarTagID',
      'raisedCattleMortalitiesForm.causeOfDeath',
      'raisedCattleMortalitiesForm.dateOfDeath',
      'raisedCattleMortalitiesForm.mortalityRemarks'  
      
      
  ]),

      ...mapGetters('mortalitiesData', {
      mortality: 'selectedRaisedCattleMortality',
  ...
  methods: {
      ...mapActions('mortalitiesData', ['addNewRaisedCattleMortality','getAllRaisedCattleMortalities', 'load']),
   ...
   loading() {
    ...
    async onSubmit() {
        ...
        onConfirm: async () => {
          ...
          await this.addNewRaisedCattleMortality();
