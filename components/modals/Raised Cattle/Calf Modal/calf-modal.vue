      ...
      <div>
       ...
       <div  class="columns">
         ...
         <div  class="columns">
           ...
           <b-select  v-model="calfSex" placeholder="Select a sex">
        ...
        <div  class="columns">
           ...
           <div  class="column is-three-quarters">
            ...
            <b-input :disabled="!calfWeight" type="text" v-model="raisedEarTagID" placeholder="Ear Tag ID"></b-input>
           </div>
         </div>
        ...
        <div  class="columns">
           ...
           <div  class="column is-three-quarters">
            ...
            <b-input  :disabled="!calfWeight" type="text" v-model="earTagColor" placeholder="Ear Tag Color"></b-input>
           </div>
         </div>

          <h4> <span class="is-blue">Animal Color(s)</span></h4>
        <div  class="columns">
        ...
        <div class="columns">
         ...
         <div :disabled="!calfRemarks" class=" card my-4">
           ...
           <p>Sire:  {{sire}}</p>
           <p>Dam (Purchased):  {{dam}}</p>
           <p>Dam (Raised):  {{raisedDam}}</p>
           <p>Sex:  {{calfSex}}</p>
