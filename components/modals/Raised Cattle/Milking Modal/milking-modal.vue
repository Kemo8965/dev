         ...
         <h4> <span class="is-blue">Ear Tag ID</span></h4>
          ...
          <div class="columns">
           ...
           <div class=" summary-content">
            ...
            <p>Ear Tag ID(Raised):  {{raisedEarTagID}}</p>
...
export default {
  name: 'MilkingModal',
   ...
   computed: {
      ...
      'raisedMilkingForm',
      'raisedMilkingForm.raisedEarTagID',
      'raisedMilkingForm.firstMilking',
      'raisedMilkingForm.secondMilking',
      'raisedMilkingForm.milkingDate'
  ...
  methods: {
      ...mapActions('cattleData', ['addNewRaisedCattleDMR','getAllRaisedCattleDMRs', 'load']),
   ...
   loading() {
      return this.DMRLoading 
         ...
         async  filteredDataArray() {
           ...
           const earTagOptions = await this.getAllRaisedCattleDMRs();
    ...
    async onSubmit() {
        ...
        onConfirm: async () => {
           ...
           await this.addNewRaisedCattleDMR();
