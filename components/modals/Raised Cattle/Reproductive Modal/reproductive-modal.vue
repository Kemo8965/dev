<template>
  <div class="modal-card ">
    ...
    <section class="modal-card-body has-background-white">
      <!-- Modal Content -->
      <div>
       <b-form v-model="raisedCattleReproductiveForm" class="form">
        ...
        <div class="columns">
           ...
           <div  class="column is-three-quarters">
            ...
            <b-input type="number" :disabled="!raisedEarTagID" v-model="numberOfServicesPerInsemination" placeholder="No. of Services Per Insemination"></b-input>
           </div>
         </div>
...
export default {
  name: 'reproductiveModal',
   ...
   computed: {
      ...
      'raisedCattleReproductiveForm',
      'raisedCattleReproductiveForm.raisedEarTagID',
       'raisedCattleReproductiveForm.ageAtFirstCalving',
      'raisedCattleReproductiveForm.numberOfServicesPerInsemination',
       'raisedCattleReproductiveForm.calvingInterval',
      'raisedCattleReproductiveForm.calvingEaseIndex',
      'raisedCattleReproductiveForm.abortionsPerLifecycle'
  ...
  methods: {
      ...mapActions('reproductiveData', ['addNewRaisedCattleReproductive','getAllRaisedCattleReproductives', 'load']),
   ...
   loading() {
    ...
    async onSubmit() {
     ...
     // this.Loading= true
      await this.addNewRaisedCattleReproductive();
