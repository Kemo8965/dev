<template>
  <div class="modal-card ">
    ...
    <section class="modal-card-body has-background-white">
      <!-- Modal Content -->
      <div>
       <b-form v-model="raisedCattleTreatmentForm" class="form">
         ...
         <div class="columns">
           ...
           <b-input type="text" :disabled="!raisedEarTagID" v-model="symptomsDisplayed" placeholder="Symptoms Displayed"></b-input>
           </div>
...
export default {
  name: 'TreatmentModal',
   ...
   computed: {
    ...
    filteredDataArray() {
      ...
      'raisedCattleTreatmentForm.raisedEarTagID',
      'raisedCattleTreatmentForm.symptomsDisplayed',
      'raisedCattleTreatmentForm.diagnosis',
      'raisedCattleTreatmentForm.drugsAdministered',
      'raisedCattleTreatmentForm.treatmentRemarks',
      'raisedCattleTreatmentForm.withdrawalPeriod'
      
      
  ]),

      ...mapGetters('treatmentData', {
        cattles:'allPurchasedCattleTreatments',
  ...
  methods: {
      ...mapActions('treatmentData', ['addNewRaisedCattleTreatment','getAllRaisedCattleTreatments', 'load']),
   ...
   loading() {
    ...
    async onSubmit() {
        ...
        await this.addNewRaisedCattleTreatment();
