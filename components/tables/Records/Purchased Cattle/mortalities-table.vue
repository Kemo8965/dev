<template>
  <div>
    ...
    >
      ...
      >
      <span class="tag is-info is-light"> {{ props.row.purchasedEarTagID}} </span>
       ...
       <b-table-column
        ...
        sortable
      >
      <span class="tag is-danger is-light">  {{ props.row.causeOfDeath }} </span>
      </b-table-column>
       ...
       <b-table-column
        ...
        sortable
      >
      <span class="tag is-info is-light"> {{ props.row.dateOfDeath }} </span>
      </b-table-column>
     ...
     <b-table-column v-slot="props" label="Options">
        <span class="buttons">
          ...
          <b-tooltip label="View more" type="is-dark">
          <b-button
...
import MortModal from '@/components/modals/Purchased Cattle/Mort Modal/mort-modal.vue'
import MortSnapshotModal from '@/components/modals/Purchased Cattle/Mort Modal/mort-snapshot-modal.vue'
export default {
  ...
  computed: {
    ...
    ...mapGetters('mortalitiesData', {
        loading: 'loading',
        mortalities:'allPurchasedCattleMortalities',
      }),
  ...
  methods: {
     ...
     ...mapActions('mortalitiesData', ['addNewPurchasedCattleMortality','getAllPurchasedCattleMortalities', 'load', 'selectPurchasedCattleMortality']),

     async refresh(){
    //  this.isLoading = true
      await this.getAllPurchasedCattleMortalities();
   //   this.isLoading = false
    ...
    captureReceipt(mortality) {
      this.selectPurchasedCattleMortality(mortality)
      setTimeout(() => {
