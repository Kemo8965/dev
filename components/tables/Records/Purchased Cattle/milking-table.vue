...
import MilkingModal from '~/components/modals/Purchased Cattle/Milking Modal/milking-modal.vue'
import PurchasedMilkingSnapshotModal from '~/components/modals/Purchased Cattle/Milking Modal/milking-snapshot-modal.vue'
export default {
  ...
  //  this.selectPurchasedCattleDMR(this.DMRs[0])
  },
  ...
  methods: {
     ...
     ...mapActions('cattleData', ['addNewDMR', 'getTotalMikingRecords','getAllPurchasedDMRs', 'load', 'selectPurchasedCattleDMR']),
   ...
   const notification = new Notification("New message from Litmas!", {
    ...
    //  this.isLoading = true
      await this.getAllPurchasedDMRs();
   ...
   //   this.isLoading = false
    ...
    captureReceipt(DMR) {
      this.selectPurchasedCattleDMR(DMR)

      
      setTimeout(() => {
        this.$buefy.modal.open({
          parent: this,
          component: PurchasedMilkingSnapshotModal,
          hasModalCard: true,
          trapFocus: true,
          canCancel: ['x'],
          destroyOnHide: true,
