<template>
  <div>
    ...
    >
      ...
      >
       <span class="tag  is-light"> {{ props.row.purchasedEarTagID }} </span>
...
import TreatmentModal from '~/components/modals/Purchased Cattle/Treatment Modal/treatment-modal.vue'
import TreatmentSnapshotModal from '~/components/modals/Purchased Cattle/Treatment Modal/treatment-snapshot-modal.vue'
export default {
  ...
  computed: {
    ...
    ...mapGetters('treatmentData', {
        loading: 'loading',
        treatments:'allPurchasedCattleTreatments',
      }),
  ...
  methods: {
     ...
     ...mapActions('treatmentData', ['addNewTreatment','getAllPurchasedCattleTreatments', 'load', 'selectPurchasedCattleTreatment']),
   ...
   //   this.isLoading = false
    ...
    captureReceipt(treatment) {
      this.selectPurchasedCattleTreatment(treatment)
      setTimeout(() => {
