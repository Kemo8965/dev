...
import FeedSnapshotModal from '~/components/modals/Purchased Cattle/Feed Modal/feed-snapshot-modal.vue'
export default {
...
// }
  ...
  methods: {
     ...
     ...mapActions('cattleData', ['addNewDMR','getAllPurchasedCattleDMRs', 'getTotalMikingRecords', 'load', 'selectPurchasedCattleDMR']),
   ...
   const notification = new Notification("New message from Litmas!", {
    ...
    //  this.isLoading = true
      await this.getAllPurchasedCattleDMRs();
