...
import MilkingSnapshotModal from '~/components/modals/Raised Cattle/Milking Modal/milking-snapshot-modal.vue'
export default {
  ...
  methods: {
     ...
     ...mapActions('cattleData', ['addNewDMR','getAllRaisedDMRs', 'getTotalMikingRecords', 'load', 'selectRaisedCattleDMR']),
