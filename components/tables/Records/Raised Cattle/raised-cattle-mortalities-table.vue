<template>
  <div>
    ...
    >
      ...
      >
      <span class="tag is-info is-light"> {{ props.row.raisedEarTagID }} </span>
...
import MortModal from '@/components/modals/Raised Cattle/Mort Modal/mort-modal.vue'
import MortSnapshotModal from '@/components/modals/Raised Cattle/Mort Modal/mort-snapshot-modal.vue'
export default {
  ...
  computed: {
    ...
    ...mapGetters('mortalitiesData', {
        loading: 'loading',
        mortalities:'allRaisedCattleMortalities',
      }),
  ...
  methods: {
     ...
     ...mapActions('mortalitiesData', ['addNewRaisedCattleMortality','getAllRaisedCattleMortalities', 'load', 'selectRaisedCattleMortality']),

     async refresh(){
    //  this.isLoading = true
      await this.getAllRaisedCattleMortalities();
   //   this.isLoading = false
    ...
    captureReceipt(mortality) {
      this.selectRaisedCattleMortality(mortality)
      setTimeout(() => {
