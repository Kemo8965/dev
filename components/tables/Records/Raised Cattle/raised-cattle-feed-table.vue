<template>
  <div>
    ...
    <b-tooltip multilined label="Calculated based on daily milking sessions per cow.
      ...
      >
        ...
        <b-tooltip multilined label="Calculated based on Daily Milking Yield Per Cow.
...
import MilkingModal from '~/components/modals/Raised Cattle/Milking Modal/milking-modal.vue'
import FeedSnapshotModal from '~/components/modals/Raised Cattle/Feed Modal/feed-snapshot-modal.vue'
export default {
  name: 'RaisedCattleFeedTable',
...
//     })
// }
   this.selectRaisedCattleDMR(this.DMRs[0])
  },
  ...
  methods: {
     ...
     ...mapActions('cattleData', ['addNewDMR','getAllRaisedCattleDMRs', 'getTotalMikingRecords', 'load', 'selectRaisedCattleDMR']),
   ...
   const notification = new Notification("New message from Litmas!", {
    ...
    //  this.isLoading = true
      await this.getAllRaisedCattleDMRs();
   ...
   //   this.isLoading = false
    ...
    captureReceipt(DMR) {
      this.selectRaisedCattleDMR(DMR)
