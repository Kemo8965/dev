  ...
  <div>
    ...
    >
     ...
     <b-table-column
      ...
      <span class="tag earTagID ">  {{ props.row.raisedEarTagID }} </span>
     ...
     <b-table-column v-slot="props" label="Options">
      ...
      <template #empty>
       ...
       <b-tooltip  label="Once freshed, your details will appear here" type="is-dark">
          <h4 class="is-size-4 text-center has-text-centered">No Bulling Heifer Data yet. &#x1F4DA;. Click the <span class="tag is-info"> refresh button</span> right above</h4>
       </b-tooltip>
      </template>
    </b-table>
        </div>
