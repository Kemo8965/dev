...
import SalesModal from '~/components/modals/Purchased Cattle/Sales Modal/sales-modal.vue'
import SalesSnapshotModal from '~/components/modals/Purchased Cattle/Sales Modal/sales-snapshot-modal.vue'
export default {
